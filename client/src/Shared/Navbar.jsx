            ...
            {/* {
                ...
                <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6 container mx-auto ">
                    <div className="flex  items-center justify-between">
                        <Link to="/">
                            <img src={logo3} alt="" className='h-14 cursor-pointer' />
                        </Link>
                        <div className="lg:flex hidden gap-8 items-center">
                            <a href="/#sector1" className="text-[#191919] text-xl font-medium hover:text-red-500">Today Special</a>
                            ...
                            <a href="/#sector2" className="text-[#191919] text-xl font-medium hover:text-red-500">Popular food</a>
