...
import chef from "../assets/menu.jpg"
const Header = () => {
    return (
        <div className="bg-yellow-20/80 py-3 px-10 sm:px-4 md:px-6 lg:px-6 bg-white">
            <div className="container mx-auto py-[16vh]">
                <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="h-50 w-300">
                        <img src={chef} className=' h-[28rem] mx-auto justify-end' alt="" />
                    </div>
                </div>
